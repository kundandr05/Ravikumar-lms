...
export default function UniversalLearningPlayer({ params }: { params: Promise<{ courseId: string, mediaId: string }> }) {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-card text-card-foreground p-6 rounded-xl shadow-sm border space-y-4">
        ...
        {media.description && <p className="text-muted-foreground leading-relaxed">{media.description}</p>}
      </div>
    </div>
  );
}
