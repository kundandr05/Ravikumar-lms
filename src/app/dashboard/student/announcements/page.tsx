  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-2">Important updates and live class links from your instructor.</p>
      </div>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-16 border-2 border-dashed rounded-lg bg-slate-50 text-slate-500 flex flex-col items-center">
              ...
              <p className="text-lg font-medium text-slate-700">No announcements yet</p>
              <p className="text-sm mt-1">Check back later for updates from your instructor.</p>
            </div>
          ) : (
            <div className="space-y-4">
              {announcements.map((ann) => (
                <div key={ann.announcementId} className="p-5 rounded-xl border border-slate-200 bg-white hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-bold text-xl text-slate-900">{ann.title}</h3>
