              ...
              <CardContent className="p-8 space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-amber-100">contact@raviclasses.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-amber-100">New Delhi, India</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-8 mt-8 border-t border-amber-500">
                  <a 
                    ...
                    className="flex items-center justify-center gap-2 w-full bg-green-500 text-white px-4 py-3 rounded-md hover:bg-green-600 transition-colors font-bold"
                  >
              ...
              <CardContent className="p-8">
                ...
                {success ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full md:w-auto bg-slate-900 hover:bg-slate-800 text-white px-8" disabled={loading}>
