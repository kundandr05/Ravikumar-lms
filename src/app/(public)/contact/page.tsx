                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/919902580100" target="_blank" rel="noopener noreferrer" className="text-amber-100 hover:text-primary-foreground transition-colors underline-offset-4 hover:underline">+91 99025 80100</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <a href="mailto:ravijog23@gmail.com" className="text-amber-100 hover:text-primary-foreground transition-colors underline-offset-4 hover:underline">ravijog23@gmail.com</a>
                      </div>
                    </div>
                  </div>
