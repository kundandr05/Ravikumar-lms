    ...
    <div className="py-20 bg-slate-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          <div className="w-full md:w-1/3 aspect-square bg-slate-200 rounded-2xl shadow-md flex items-center justify-center text-slate-400 shrink-0">
            {/* Image Placeholder */}
              ...
              <Card>
                <CardContent className="p-4 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">M.A. (English), B.Ed</p>
                  </div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-4 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">17+ Years in Education</p>
                  </div>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="space-y-8 pt-8 border-t">
          <h2 className="text-3xl font-bold text-slate-900 text-center">Teaching Methodology</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-t-4 border-t-amber-500">
              <CardContent className="p-6 space-y-3">
                <h3 className="text-xl font-bold text-slate-900">Conceptual Clarity</h3>
                <p className="text-slate-600">Moving beyond rote memorization to ensure students deeply understand the 'why' and 'how' of every topic.</p>
              </CardContent>
            </Card>
            <Card className="border-t-4 border-t-amber-500">
              <CardContent className="p-6 space-y-3">
                <h3 className="text-xl font-bold text-slate-900">Exam-Oriented Approach</h3>
                <p className="text-slate-600">Strategic preparation aligned exactly with the latest CBSE board patterns and marking schemes.</p>
              </CardContent>
            </Card>
            <Card className="border-t-4 border-t-amber-500">
              <CardContent className="p-6 space-y-3">
                <h3 className="text-xl font-bold text-slate-900">Interactive Learning</h3>
                <p className="text-slate-600">Engaging visual presentations and real-world examples that make Social Science and English come alive.</p>
              </CardContent>
            </Card>
          </div>
        </div>
