    ...
    <footer className="bg-slate-900 text-slate-300 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-primary-foreground font-semibold mb-4 uppercase text-sm tracking-wider">Quick Links</h4>
          ...
          <div>
            <h4 className="text-primary-foreground font-semibold mb-4 uppercase text-sm tracking-wider">Support</h4>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <h4 className="text-primary-foreground font-semibold mb-4 uppercase text-sm tracking-wider">Contact Info</h4>
            <ul className="space-y-2 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  <a href="https://wa.me/919902580100" target="_blank" rel="noopener noreferrer" className="hover:text-amber-500 transition-colors">+91 99025 80100</a>
                </li>
                <li className="flex items-start sm:items-center gap-2 flex-col sm:flex-row">
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4 text-amber-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                  ...
                  <div className="flex items-center sm:ml-0 ml-6">
                    <a href="mailto:ravijog23@gmail.com" className="hover:text-amber-500 transition-colors">ravijog23@gmail.com</a>
                  </div>
                </li>
            </ul>
            <a
              href="https://wa.me/919902580100"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-4 bg-emerald-600 text-primary-foreground px-4 py-2 rounded-md hover:bg-green-600 transition-colors text-sm font-medium"
            >
