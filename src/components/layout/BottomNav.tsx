...
export function BottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-xl border-t border-white/30 shadow-[0_-4px_30px_rgba(0,0,0,0.1)] safe-area-pb">
